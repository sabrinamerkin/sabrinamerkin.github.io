...
On the first dashboard, locate the summary area chart. In the dropdown box, we will first select *Hour* to view the distribution of chatroom queues throughout the day. We can find that users can attempt to join a chatroom at any hour of the day. However, chatroom availability does not open until 9:00am and closes after 9:00pm. Users may be inclined to start their queues early to increase their odds of joining a chatroom when availability opens.
