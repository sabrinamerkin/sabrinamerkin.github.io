...
On the contrary, users with successful queues that were initiated between 8:00pm and 9:00pm enjoyed the shortest median queue duration. These users had a median queue duration of 3 minutes. Keep in mind that the 8:00pm to 9:00pm queue window also saw the worst queue success rate. 
