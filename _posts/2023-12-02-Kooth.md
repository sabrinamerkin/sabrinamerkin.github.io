...
Along the top of the first dashboard, we can see the total records for booked chats, queue successes, and queue failed. The number of failed queues greatly outnumbers successful queues into chats. This should be an area of focus for improvement.

## What queue attempt patterns can we see throughout the day?
On the first dashboard, locate the summary area chart. In the dropdown box, we will first select *Hour* to view the distribution of chatroom queues throughout the day. To begin, we find that users can attempt to join a chatroom at any hour of the day. However, chatroom availability does not open until 9:00am and closes after 9:00pm. Users may be inclined to start their queues early to increase their odds of joining a chatroom when availability opens.

We can see the first activity spike occurrs between 11:00am and 12:00pm. Queue attempts slow down in the early afternoon and begin to increase again after 4:00pm. The most popular time to queue for a chat occured between 8:00pm and 9:00pm.
...
During operational chatroom hours, users that queued for a chat between 8:00pm and 9:00pm had the worst success rate at 3.19%. Considering that 8:00pm to 9:00pm is also the most popular time to queue for a chat, staffing more counselers during this time could increase successful queues.
