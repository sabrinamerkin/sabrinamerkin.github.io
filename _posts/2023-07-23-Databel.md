...
Navigate to the Overview tab in the storyboard. Looking at the Churn by Category pie chart, 44.82% of churned customers last quarter left Databel due to competitor-related reasons. This is reflected in the Churn Reasons chart, where we can see that 2 of the top 3 churn reasons are in fact related to competitors. In first place, we see that 16.87% of churned customers left because a competitor made them a better offer. Similarly, 16.54% of churned customers left because a competitor had better devices.
