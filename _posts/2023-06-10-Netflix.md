...
Next, I imported the Pandas library to create a data frame from this dictionary. I also import the Matplotlib.pyplot library to visualize any potential trend between the two fields in this data frame.
...
Looking at the "type" field, we can see there are also TV shows included in this data set. We can create a new data frame "netflix_movies" containing only "title", "country", "genre", "release_year", and "duration".
