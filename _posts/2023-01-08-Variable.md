...
Next, we can take a better look at comparing the distributions of each field for those who have diabetes and those who do not. Each of the following plots depict the distributions of each variable for patients who had diabetes (outcome=1) or did not have diabetes (outcome=0).
