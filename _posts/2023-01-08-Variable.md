...
The t-test between `Outcome` and `Glucose` has a significant p-value (< 0.01). This indicates that `Glucose` should be a reasonable variable to select in the final logistic regression model.
