...
While there are many methods to consider while choosing variables for a logistic regression model, AIC and t-tests provided insightful and effective information criterion for this study.
